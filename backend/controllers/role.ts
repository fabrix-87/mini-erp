...
export const syncPermissions = asyncHandler(async (req: AuthRequest, res: Response) => {
  ...
  const defaultPermissions = [
    ...
    { code: 'document:approve', resource: 'document', action: 'approve', description: 'Approvazione documenti' },
    ...
    { code: 'opportunity:read', resource: 'opportunity', action: 'read', description: 'Lettura opportunità' },
    { code: 'opportunity:create', resource: 'opportunity', action: 'create', description: 'Creazione opportunità' },
    { code: 'opportunity:update', resource: 'opportunity', action: 'update', description: 'Modifica opportunità' },
    { code: 'opportunity:delete', resource: 'opportunity', action: 'delete', description: 'Eliminazione opportunità' },
    { code: 'opportunity:manage', resource: 'opportunity', action: 'manage', description: 'Gestione completa opportunità' },
    ...
    { code: 'tax:manage', resource: 'tax', action: 'manage', description: 'Gestione completa tasse' },

    // Payment permissions
    { code: 'payment:read', resource: 'payment', action: 'read', description: 'Lettura metodi pagamento' },
    { code: 'payment:create', resource: 'payment', action: 'create', description: 'Creazione metodi pagamento' },
    { code: 'payment:update', resource: 'payment', action: 'update', description: 'Modifica metodi pagamento' },
    { code: 'payment:delete', resource: 'payment', action: 'delete', description: 'Eliminazione metodi pagamento' },
    { code: 'payment:manage', resource: 'payment', action: 'manage', description: 'Gestione completa metodi pagamento' },

    // PriceList permissions
    { code: 'pricelist:read', resource: 'pricelist', action: 'read', description: 'Lettura listini prezzi' },
    { code: 'pricelist:create', resource: 'pricelist', action: 'create', description: 'Creazione listini prezzi' },
    { code: 'pricelist:update', resource: 'pricelist', action: 'update', description: 'Modifica listini prezzi' },
    { code: 'pricelist:delete', resource: 'pricelist', action: 'delete', description: 'Eliminazione listini prezzi' },
    { code: 'pricelist:manage', resource: 'pricelist', action: 'manage', description: 'Gestione completa listini prezzi' },

    // Category permissions
    { code: 'category:read', resource: 'category', action: 'read', description: 'Lettura categorie' },
    { code: 'category:create', resource: 'category', action: 'create', description: 'Creazione categorie' },
    { code: 'category:update', resource: 'category', action: 'update', description: 'Modifica categorie' },
    { code: 'category:delete', resource: 'category', action: 'delete', description: 'Eliminazione categorie' },
    { code: 'category:manage', resource: 'category', action: 'manage', description: 'Gestione completa categorie' },

    // Dashboard permissions
    { code: 'dashboard:read', resource: 'dashboard', action: 'read', description: 'Visualizzazione dashboard' },
    ...
    { code: 'report:manage', resource: 'report', action: 'manage', description: 'Gestione completa report' },
  ];
