...
import type { UpdateUserDetailsInput, UpdateUserProfileInput } from '@mini-erp/shared/types';
...
export async function updateProfileAction(
  data: UpdateUserDetailsInput & Pick<UpdateUserProfileInput, 'username' | 'preferredLanguageId'>,
) {
