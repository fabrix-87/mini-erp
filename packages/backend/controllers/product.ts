 ...
 * @access  Public
 */
export const getAllProducts = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const {
    page = 1,
    limit = 20,
    search,
 ...
 * @access  Public
 */
export const getProductById = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
 ...
 */
export const createProduct = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
 ...
 * @access  Private (Admin, Product Manager)
 */
export const updateProduct = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
 ...
 */
export const deleteProduct = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
 ...
 * @access  Public
 */
export const getProductVariants = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
 ...
 * @access  Public
 */
export const getVariantById = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
 ...
 * @access  Private (Admin, Product Manager)
 */
export const createVariant = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
 ...
 * @access  Private (Admin, Product Manager)
 */
export const updateVariant = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
  const updateData = req.validatedBody;
 ...
 * @access  Private (Admin)
 */
export const deleteVariant = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
 ...
 */
export const createSimpleProduct = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const {
    // Dati prodotto
    reference,
    defaultTaxRuleId,
 ...
 * @access  Public
 */
export const getProductTranslations = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
 ...
 * @access  Private (Admin, Product Manager)
 */
export const createTranslation = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
  const translationData = req.validatedBody;
 ...
 * @access  Private (Admin, Product Manager)
 */
export const updateTranslation = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
 ...
 * @access  Private (Admin, Product Manager)
 */
export const deleteTranslation = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id, languageId } = req.validatedParams;
 ...
 * @access  Public
 */
export const getProductImages = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
 ...
 * @access  Private (Admin, Product Manager)
 */
export const createImage = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
  const imageData = req.validatedBody;
 ...
 * @access  Private (Admin, Product Manager)
 */
export const updateImage = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
  const updateData = req.validatedBody;
 ...
 * @access  Private (Admin, Product Manager)
 */
export const deleteImage = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
 ...
 * @access  Private (Admin, Product Manager)
 */
export const setCoverImage = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { productId, id } = req.validatedParams;
 ...
 * @access  Public
 */
export const getProductCategories = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
 ...
 * @access  Private (Admin, Product Manager)
 */
export const addCategory = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
  const { categoryId, position = 0 } = req.validatedBody;
 ...
 * @access  Private (Admin, Product Manager)
 */
export const removeCategory = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
 ...
 * @access  Private (Admin, Product Manager)
 */
export const updateCategoryPosition = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { productId, categoryId } = req.validatedParams;
  const { position } = req.validatedBody;
 ...
 * @access  Public
 */
export const getAllManufacturers = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
 ...
 * @access  Public
 */
export const getManufacturerById = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
 ...
 * @access  Private (Admin, Product Manager)
 */
export const createManufacturer = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
 ...
 * @access  Private (Admin, Product Manager)
 */
export const updateManufacturer = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
  const updateData = req.validatedBody;
 ...
 * @access  Private (Admin)
 */
export const deleteManufacturer = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
  const { id } = req.validatedParams;
 ...
 * @access  Private (Admin, Product Manager)
 */
export const bulkUpdateProducts = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
 ...
 * @access  Private (Admin)
 */
export const bulkDeleteProducts = asyncHandler(async (req: AuthenticatedValidatedRequest, res: Response) => {
