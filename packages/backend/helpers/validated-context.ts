 ...
 * @returns 
 */
export const getValidatedBody = <T>(c: Context<AppBindings>): T =>
 ...
 * @returns 
 */
export const getValidatedQuery = <T>(c: Context<AppBindings>): T =>
 ...
 * @returns 
 */
export const getValidatedParams = <T>(c: Context<AppBindings>): T =>
  c.get('validatedParams') as T